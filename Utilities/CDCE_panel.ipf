...
//	DrawText 7,38, SQVERSION // "ver. 1.0"		//1.65L
	...
	DrawText 2,59,"*Only applicable to ambient, non free trop. data*"
	SetDrawEnv fsize= 10
	DrawText 7,93,"Step 0. Verify your NH4 RIE."
	SetDrawEnv fsize= 10
	DrawText 13,189,"in µg/m3, with CE=1, AB corrected"
	SetDrawEnv fsize= 10
//	DrawText 5,334,"Step 7. (Opt.) Enter CE_fphase in Batch table."
//	SetDrawEnv fsize= 10
	DrawText 5,218,"Step 3. (Optional)"
	SetDrawEnv fsize= 10
	DrawText 5,254,"Step 5. (Optional)"
	SetDrawEnv fsize= 10
	DrawText 2,205,"if NH4<min level, default CE (step 4) will be used"
	SetDrawEnv fsize= 11
	DrawText 5,235,"Step 4. Notice that the default CE will be 0.5"
	...
	Button ceReviewNH4RIE,pos={170.00,75.00},size={70.00,18.00},proc=CheckCalibButton_proc
	Button ceReviewNH4RIE,title="UMR RIEs",fSize=10
	Button buttonCalcTSforCE,pos={5,95},size={210,20},fsize=10,proc=sq_butt_CalcTS_CDCE,title="Step 1. Calculate aerosol TS with CE=1"
	Button buttonCalcTSforCE,fColor=(65280,43520,0)
	Button CEis1_TSGraph,pos={217,95},size={40,20},fsize=10,proc=sq_create_CEis1_TSgraph,title="Graph"
	Button sq_butt_CENH4AcidityGraph,pos={5.00,118.00},size={80.00,20.00},proc=sq_butt_CENH4AcidityGr
	Button sq_butt_CENH4AcidityGraph,title="NH\\B4\\M meas/pred",fSize=10


	GroupBox groupParams,pos={1,144},size={255,153},fsize=11,title="CDCE user parameters"
	GroupBox groupParams,fColor=(1,1,1)
	GroupBox groupOptionalPrelim,pos={1,62},size={255,78},fsize=11,title="Preliminary calculations using CE=1"
	...
	SetVariable NH4DetLim,pos={8.00,157.00},size={249.00,16.00},bodyWidth=35
...
//	SetVariable NH4DetLim,fSize=11,format="%1.3f",limits={0,1,0},value=_NUM:Nan
	Button Butt_SetNH4LOD,pos={202,174},size={50,20},fsize=10,proc=SetNH4LOD,title="NH4 LOD"
	CheckBox checkUseRH,pos={105,239},size={145,14},fsize=10,title="Use RH of sampling line, %"
	CheckBox checkUseRH,value= 0
	CheckBox checkUseSmooth,pos={97,205},size={112,14},fsize=10,title="Num. pts. to smooth"
	CheckBox checkUseSmooth,value= 0
	SetVariable Num2SmoothVar,pos={220,205},size={30,20},fsize=10,bodyWidth=40,value=_NUM:0
	SetVariable setvarRH,pos={23,256},size={230,16},fsize=10,title="RH wave of ACSM sampling line, in root",size={230,16}
	SetVariable setvarRH,value= _STR:""

	Button buttonCalcCE,pos={5,297},size={240,20},fsize=10,proc=sq_butt_Calc_CDCE,title="Step 6. Calculate composition dependent CE"
	Button buttonCalcCE,fColor=(65280,43520,0)


	Button ceSetInflectionPoints,pos={3.00,274.00},size={245.00,18.00},proc=sq_butt_CEAdvPanel
...
//	TabControl tabCE,tabLabel(0)="CE Hist",tabLabel(1)="CDCE vs CE"
	...
	TabControl tabCE,tabLabel(3)="NO3",tabLabel(4)="SO4",tabLabel(5)="Org"
	TabControl tabCE,tabLabel(6)="Chl",value= 0
...
Function sq_butt_CENH4AcidityGr(ctrlName) : ButtonControl
	String ctrlName
	SVAR PathToConcData
//	tempfolder = GetBrowserSelection(0)
	Setdatafolder PathToConcData//root:ToF_ACSM:
	wave NH4, SO4, NO3, Chl//, PredNH4
...
//	else	
		...
		PredNH4=18*(SO4/96*2+NO3/62+Chl/35.45)
...
//	wave/t spec_list  = root:frag:spec_list
	wave/Z OM, SO4,NH4,NO3,Cl, Org, Chl//, DateW
//	Setdatafolder root:CE
	...
	variable NH4Row, SO4Row, NO3Row, ChlRow, OrgRow
	variable NH4_CEVal, SO4_CEVal, NO3_CEVal, Chl_CEVal, Org_CEVal
	variable killFlag, numTSeries, UseRH=0, detectorFlag
	Wave NH4_CECorr, SO4_CECorr, NO3_CECorr, Chl_CECorr, Org_CECorr
...
//	endif
	...
	duplicate/o Org_CE1 root:CE:Total_CE1/wave=Total_CE1
 	Total_CE1 = NH4_CE1+SO4_CE1+NO3_CE1+Chl_CE1+Org_CE1

	//put results into CE folder.
	duplicate/o NH4_CE1 root:CE:NH4_CE1
	duplicate/o SO4_CE1 root:CE:SO4_CE1
	duplicate/o NO3_CE1 root:CE:NO3_CE1
	duplicate/o Chl_CE1 root:CE:Chl_CE1
	duplicate/o Org_CE1 root:CE:Org_CE1
	duplicate/o Org_CE1 root:CE:Org_CE1

	killwaves/z NH4_CE1, SO4_CE1, NO3_CE1, Chl_CE1, Org_CE1
	
	SetDataFolder root:CE
	Duplicate/O Org_CE1, Org_CDCE
	Duplicate/O NH4_CE1, NH4_CDCE
	Duplicate/O SO4_CE1, SO4_CDCE
	Duplicate/O NO3_CE1, NO3_CDCE
	Duplicate/O Chl_CE1, Chl_CDCE
...
Function sq_butt_Calc_CDCE(ctrlName) : ButtonControl
	...
	wave SO4_CE1 = root:CE:SO4_CE1
 	wave NO3_CE1 = root:CE:NO3_CE1
  	wave Chl_CE1 = root:CE:Chl_CE1
 	wave Org_CE1 = root:CE:Org_CE1
...
//		SmoothTypeVar=v_value
	...
	if (V_value)
		...
		wave/z RHSampleLineWave = gen_returnSelectedWave("setVarRH", DFstr="root:", num=numTSeries, minVal=0, maxVal=110, nansOK=0)
 	...
 	if (WaveExists(RHSampleLineWave))
 		if (SmoothVar>=1)
 			sq_CalcCE_fPhase(NH4_DetLimit,varCE_lowNH4, SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1, RH_SampLine= RHSampleLineWave, SmoothVariable=SmoothVar, SmoothTypeVariable=SmoothTypeVar)
 		else
  			sq_CalcCE_fPhase(NH4_DetLimit,varCE_lowNH4, SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1, RH_SampLine= RHSampleLineWave)
		endif
 	else
 		if (SmoothVar>=1)
 			sq_CalcCE_fPhase(NH4_DetLimit,varCE_lowNH4, SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1, SmoothVariable=SmoothVar, SmoothTypeVariable=SmoothTypeVar)
 		else
	   		sq_CalcCE_fPhase(NH4_DetLimit,varCE_lowNH4, SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1)
   		endif
 	endif
	...
	duplicate/o Chl_CE1 root:CE:Chl_CDCE/wave=Chl_CDCE
	duplicate/o Org_CE1 root:CE:Org_CDCE/wave=Org_CDCE
	...
	duplicate/o Org_CDCE root:CE:Total_CDCE/wave=Total_CDCE
 	Total_CDCE = NH4_CDCE+SO4_CDCE+NO3_CDCE+Chl_CDCE+Org_CDCE
...
Function sq_CalcCE_fPhase(NH4_DetLimit,varCE_lowNH4, SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1, [RH_SampLine, SmoothVariable, SmoothTypeVariable])
	variable NH4_DetLimit,varCE_lowNH4, SmoothVariable, SmoothTypeVariable
	wave SO4_CE1, NH4_CE1, NO3_CE1, Chl_CE1, Org_CE1, RH_SampLine
	//print NH4_DetLimit
...
// 	(5×CEdry -4)+((1-CEdry)/20)×RH)
	...
	duplicate/o Chl_CE1 root:CE:Chl_CE1_smooth/wave=Chl_CE1_smooth
	duplicate/o Org_CE1 root:CE:Org_CE1_smooth/wave=Org_CE1_smooth
...
//		gen_InterpolateAcrossTime(root:index:t_series,SO4_CE1_smooth)
		...
		gen_InterpolateAcrossTime(root:ToF_ACSM:DateW,Org_CE1_smooth)	
		gen_InterpolateAcrossTime(root:ToF_ACSM:DateW,Chl_CE1_smooth)	
		if (SmoothVariable ==2)		// boxcar smoothing
			Smooth/B=(SmoothVariable), SmoothVariable, SO4_CE1_smooth,NH4_CE1_smooth,NO3_CE1_smooth,Chl_CE1_smooth, Org_CE1_smooth			//1.57J
		else
			Smooth SmoothVariable, SO4_CE1_smooth,NH4_CE1_smooth,NO3_CE1_smooth,Chl_CE1_smooth, Org_CE1_smooth	
		endif
		...
		Chl_CE1_smooth = numtype(Chl_CE1[p])==0 ? Chl_CE1_smooth[p] : nan
		Org_CE1_smooth = numtype(Org_CE1[p])==0 ? Org_CE1_smooth[p] : nan		
	endif
	...
	PredNH4_CE1=Mass_NH4*(2*SO4_CE1_smooth/Mass_SO4+NO3_CE1_smooth/Mass_NO3+Chl_CE1_smooth/Mass_Chl)	// presume Org doesn't contribute to acidity 
	...
	ANMF=(Mass_NH4NO3/Mass_NO3)*NO3_CE1_smooth/(NO3_CE1_smooth+SO4_CE1_smooth+NH4_CE1_smooth+Org_CE1_smooth+Chl_CE1_smooth)	
...
wave RHWave
	...
	wave NH4_CE1 = root:CE:NH4_CE1
	wave SO4_CE1 = root:CE:SO4_CE1
	wave Chl_CDCE = root:CE:Chl_CDCE
	wave Org_CDCE = root:CE:Org_CDCE
	...
	WaveStats/q/m=0 Org_CE1		// could use any species wave
	numNonNans = V_npnts
	num = numpnts(Org_CE1)
...
Function sq_create_CEis1_TSgraph(ctrlName) : ButtonControl
	...
	AppendToGraph root:CE:Chl_CE1 vs root:ACMCC_Export:ACSM_time
	ModifyGraph lSize=2
	ModifyGraph rgb(Org_CE1)=(0,52224,0),rgb(NO3_CE1)=(0,0,65535)
	ModifyGraph rgb(NH4_CE1)=(65535,43690,0),rgb(Chl_CE1)=(65280,0,52224)
	ModifyGraph gaps=0
...
variable tabNum
	...
	String SpecStr, tempStr, CE1str, CDCEstr
 	...
 	if ( tabNum>=2 )		// individual species
		...
		// rows are just like tabs: NH4=0, NO3=1, SO4 = 2, Org = 3, Chl = 4
		SpecStr=StringfromList(tabNum-2, "NH4;NO3;SO4;Org;Chl;")
		avgCE1=SpeciesStats[tabNum-2][0]
		avgCDCE=SpeciesStats[tabNum-2][1]
...
Function/s SQ_getColorListSpecies(Species)
	...
	col_names ={"Org","SO4","NH4","NO3","Chl","Total"}
