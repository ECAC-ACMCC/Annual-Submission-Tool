...
//	SetVariable NH4DetLim,fSize=11,format="%1.3f",limits={0,1,0},value=_NUM:Nan
	...
	SetVariable setvarRH,pos={23,235},size={230,16},fsize=10,title="RH wave of ACSM sampling line, in root",size={230,16}
...
function CDCE2Export(ctrlName) : ButtonControl
	...
	wave CE_fphase=root:CE_fphase
	Duplicate/O OM_CDCE, root:ACMCC_Export:OM_CDCE
	Duplicate/O SO4_CDCE, root:ACMCC_Export:SO4_CDCE
	Duplicate/O NH4_CDCE, root:ACMCC_Export:NH4_CDCE
	Duplicate/O NO3_CDCE, root:ACMCC_Export:NO3_CDCE
	Duplicate/O Cl_CDCE, root:ACMCC_Export:Cl_CDCE
	Duplicate/O Total_CDCE, root:ACMCC_Export:NRPM1_CDCE
	Duplicate/O CE_fphase, root:ACMCC_Export:CDCE
