...
//	SetDataFolder root:ACMCC_Export
	...
	wave IE_NO3 = root:ACMCC_Export:IE_NO3
	wave RIE_OM = root:ACMCC_Export:RIE_OM
	wave RIE_NO3 = root:ACMCC_Export:RIE_NO3
	wave RIE_NH4 = root:ACMCC_Export:RIE_NH4
	wave RIE_SO4 = root:ACMCC_Export:RIE_SO4
	wave RIE_Cl = root:ACMCC_Export:RIE_Cl
...
//		SmoothTypeVar=v_value
	...
	if (V_value)
		...
		wave/z RHSampleLineWave = gen_returnSelectedWave("setVarRH", DFstr="root:ACMCC_Export:DryerData:", num=numTSeries, minVal=0, maxVal=110, nansOK=0)
...
//	KillWindow/Z CE_Panel
	...
	//forces ApplyMiddlebrook to 1 for traceability
