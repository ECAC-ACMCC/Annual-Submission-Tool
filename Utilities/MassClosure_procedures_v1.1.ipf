...
Function MC_init()
	...
	String/G PathToBCData="root:ExtData:BC:"
...
Function LoadBCData(ctrlName) : ButtonControl
    ...
    for(i=0; i<numFilesSelected; i+=1)
      ...
      //LoadWave/Q/O/J/M/D/K=0/L={0,0,0,3,0}/V={"\t"," $",0,0} 
		LoadWave/Z/Q/A/O/J/D/K=1/L={0,1,0,0,1}/V={"\t"," $",0,0}/R={French,2,2,2,1,"DayOfMonth/Month/Year",40} path
...
Function density_comp_corr()
	...
	wave PM_ugm3 = root:Extdata:PM:PM_ugm3
	wave eBC = root:Extdata:BC:eBC_ugm3
...
Function Avg_eBC()
	SetDataFolder root:MassClosure
	wave DateTime_BC=root:ExtData:BC:Datetime_BC
	wave eBC=root:ExtData:BC:eBC
	wave HourlyTime
	wave ACSM_time = root:ACMCC_Export:ACSM_time
	Nvar/Z TimeRef_Bool=root:MassClosure:variables:TimeRef_Bool
...
Function Avg_PM()
	SetDataFolder root:MassClosure
	wave Datetime_PM=root:ExtData:PM:Datetime_PM
	wave PM1=root:ExtData:PM:PM1
