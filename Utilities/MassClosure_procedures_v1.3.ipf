...
//	PopupMenu ExtVar_list title="Mass data type",pos={86,88},value="select;"+ InputExtLists(),proc=ExtVar2Use_ZFproc, disable = 0, win=MassClosurePanel,fstyle=1,font="Arial"
	...
	PopupMenu BCConcWave2use_list, fSize=12, pos={16,190}, size={100,15}, value = "select;" + Input_BCwaveselection(), title="Conc. wave", proc = BCConcWave2Use, disable = 0, win=MassClosurePanel,fstyle=1,font="Arial"
	PopupMenu BCDateWave2use_list, fSize=12, pos={160,190}, size={100,15}, value = "select;" + Input_BCwaveselection(), title="Date wave", proc = BCDateWave2Use, disable = 0, win=MassClosurePanel,fstyle=1,font="Arial"
	Button NoBCData_button,title="\\f01No BC data",pos={320,176},size={70,20},fSize=11,proc=NoBCData_proc,fColor=(39168,39168,39168),font="Arial"
...
//	Button sq_but_MassClosure,pos={492,121},size={40,20},fsize=10,proc=sq_butt_popThis,title="v Pop"
...
Function windowIsToBePopped(NameOfPoppedWindow)
